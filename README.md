...
This repository hosts the public legal documents required for Chrono, a sleep tracking iOS application based on chronotype science (Bear, Lion, Wolf).

**Key Privacy Highlights:**
- All sleep data stays on your device (no cloud storage)
- No third-party data sharing
- Full LGPD (Brazil) and GDPR (EU) compliance
- HealthKit data processed locally only
...
**Data Protection Officer:** leonardobilhalva@icloud.com

For privacy-related inquiries or to exercise your data rights under LGPD/GDPR, please contact us via email.
